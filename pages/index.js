  ...
  return (
    <>
      ...
      <div className="relative h-full bg-primary/60 overflow-hidden">
        ...
        {/* Main Content */}
        <div className="w-full h-full bg-gradient-to-r from-primary/70 via-black/40 to-black/10 relative z-20">
          <div className="container mx-auto flex flex-col justify-center text-center xl:text-left h-full px-6 xl:pt-40">
            {/* Title & Typewriter */}
            <motion.div
