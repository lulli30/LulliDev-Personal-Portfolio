      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-950 to-teal-950/30 text-gray-100 flex items-center">
        <div className="container mx-auto px-4 py-20 md:py-28 lg:py-36 flex items-center justify-center">
          ...
          >
            ...
            >
              Let's <span className="text-teal-400 relative">
                connect
            ...
            >
              ...
              {/* Response Message */}
              {responseMessage && (
                <div className={`text-center py-2 px-4 rounded-lg ${responseMessage.includes("success") ? "bg-green-500/20 text-green-300" : "bg-red-500/20 text-red-300"}`}>
                  {responseMessage}
                </div>
              )}
